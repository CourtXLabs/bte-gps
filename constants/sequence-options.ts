...
export const INITIAL_DIRECTION = {
  ...
  options: [
    ...
    { value: "6L", label: "Half spin to the left (6L)" },
    { value: "6R", label: "Half spin to the right (6R)" },
    { value: "7L", label: "Full spin left (7L)" },
    { value: "7R", label: "Full spin right (7R)" },
...
export const LAST_DRIBBLE_TYPE = {
  ...
  options: [
    ...
    { value: "LH6", label: "Half spin to the left (LH6)" },
    { value: "RH6", label: "Half spin to the right (RH6)" },
    { value: "LH7", label: "Full spin left (LH7)" },
    { value: "RH7", label: "Full spin right (RH7)" },
